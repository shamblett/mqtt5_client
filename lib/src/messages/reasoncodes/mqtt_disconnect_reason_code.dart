...
class MqttDisconnectReasonCodeSupport {
  static const Map<int, MqttDisconnectReasonCode>
  mqttDisconnectReasonCodeValues = <int, MqttDisconnectReasonCode>{
  ...
  static final MqttEnumHelper<MqttDisconnectReasonCode?>
  mqttDisconnectReasonCode = MqttEnumHelper<MqttDisconnectReasonCode?>(
    mqttDisconnectReasonCodeValues,
  );
}
